...
#SBATCH --mem=2G
#SBATCH --output=/data/mackanholt_lab/yp/DAM/longitudinal/output/preview/preview.%j.out
#SBATCH --error=/data/mackanholt_lab/yp/DAM/longitudinal/output/error/error.%j.err
